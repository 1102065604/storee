...
sender = "1102065604@qq.com"     # 发送人的邮件
recevises = ["1102065604@qq.com"] # 接收人列表，可以写多个
mail_host = "smtp.qq.com"       # smtp邮箱的服务器地址
password = "byuvskoqrhxegaaj"   # 本人邮件发送授权码
subject = "这是一封测试邮件"    # 本次邮件发送的主题

# message = MIMEText("这是一个计算器的测试邮件！！！","plain","utf-8")
message = MIMEMultipart()  # 附件管理器，能添加N多个附件
# 设置发送邮件的一些配置
message["From"] = Header("鲁皓", "utf-8")
message["TO"] = Header("鲁皓", "utf-8")
message["Subject"]  = Header(subject, "utf-8")

message.attach(MIMEText("这是附件","plain", "utf-8"))
# 构造附件1，传送当前目录下的 test.txt 文件
att1 = MIMEText(open('calc.html', 'rb').read(), 'base64', 'utf8')
